...
const operateDOMf = function operateDOM(){
    ...
    // remove correct letters from absent - can happen if letter is correct,
...
document.getElementById("suggestButton").addEventListener('click', function(){updateSuggestions()} ,false);
